...
#save national graph
ggsave(filename = here("figure", "national_graph_age_adjusted.png"),
...
#save graph_sex
ggsave(filename = here("figure", "graph_sex_age_adjusted.png"),
...
#save graph_race_bar
ggsave(filename = here("figure", "graph_race_age_adjusted_.png"),
...
ggsave(filename = here("figure", "map_4_years_dark_blue_age_adjusted.png"),
...
#save map_4years_cat
ggsave(filename = here("figure", "map_4years_cat_age_adjusted.png"),
...
ggsave(filename = here("figure", "map_4years_elegant_blue_age_adjusted.png"),
...
#save graph_age
ggsave(filename = here("figure", "graph_age_adjusted.png"),
